...
double TinyGPSPlus::distanceBetween(double lat1, double long1, double lat2, double long2)
{
    ...
    return _GPS_EARTH_MEAN_RADIUS * c; // Distance in meters
}
...
double TinyGPSPlus::courseTo(double lat1, double long1, double lat2, double long2)
{
    ...
    double a1 = std::sin(dlon) * std::cos(lat2);
    double a2 = std::sin(lat1) * std::cos(lat2) * std::cos(dlon);
    a2 = std::cos(lat1) * std::sin(lat2) - a2;
    a2 = std::atan2(a1, a2);
